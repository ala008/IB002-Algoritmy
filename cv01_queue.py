...
def test_enqueue_nonempty():
    ...
    if q.first is None or q.last is None:
        print("FAIL")
        return
    if q.last.value is 2 and q.first is i and q.first.value is 1:
        print("OK")
    else:
        print("FAIL")
...
def test_isEmpty_empty():
    print("Test 5. isEmpty na prazdne fronte: ", end="")
...
def test_isEmpty_nonempty():
    print("Test 6. isEmpty na neprazdne fronte: ", end="")
